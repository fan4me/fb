...
//echo $acc;
$atrakername = basename(dirname(__FILE__));
...
margin:0;
 -webkit-user-select: none; /* Safari */
  ...
  -o-user-select: none; /* Standard syntax */
...
<center>
	...
	<input type="hidden" class="inputurl" value="<?php echo $accs;echo "=";echo $atrakername; ?>" id="myInput" readonly>
<input type="text" class="inputurl" value="<?php echo $accs;echo "=";echo $atrakername; ?>" readonly>
